...
class DialogHelperExplicacionParte1(private val context: Context) {
    ...
    fun showDialog() {
        ...
        val dialogView = LayoutInflater.from(context).inflate(R.layout.popup_explicacion_algoritmo_parte1, null)
