...
class DialogHelperExplicacionParte2(private val context: Context) {
    ...
    fun showDialog() {
        ...
        val dialogView = LayoutInflater.from(context).inflate(R.layout.popup_explicacion_algoritmo_parte2, null)
        ...
        btnAtras.setOnClickListener {
            dialog.dismiss()
            val dialogHelper = DialogHelperExplicacionParte1(context)
            dialogHelper.showDialog()
        }

        btnSiguiente.setOnClickListener {
            dialog.dismiss()
            val dialogHelper = DialogHelperExplicacionParte3(context)
            dialogHelper.showDialog()
        }
