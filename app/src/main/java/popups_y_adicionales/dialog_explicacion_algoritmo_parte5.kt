...
class DialogHelperExplicacionParte5(private val context: Context) {
    // Método para mostrar el diálogo
    fun showDialog(band : Boolean) {
        // Crear un nuevo diálogo
        val dialog = Dialog(context)

       // Infla el diseño del diálogo
        val dialogView = LayoutInflater.from(context).inflate(R.layout.popup_explicacion_algoritmo_parte5, null)
